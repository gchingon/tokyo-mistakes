...
class Theme {
    ...
    onScroll() {
        const $headers = [];
        const hideOnScroll = document.body.getAttribute('data-header-hide-on-scroll') === 'true';
        const gradientOnScroll = document.body.getAttribute('data-header-gradient-on-scroll') === 'true';
        if (hideOnScroll || document.body.getAttribute('data-header-desktop') === 'auto') $headers.push(document.getElementById('header-desktop'));
        if (hideOnScroll || document.body.getAttribute('data-header-mobile') === 'auto') $headers.push(document.getElementById('header-mobile'));
        ...
        window.addEventListener('scroll', () => {
            ...
            const isMobile = Util.isMobile();
            const isScrolled = this.newScrollTop > MINIMUM;
            if (gradientOnScroll) {
            ...
            if (!isScrolled && gradientOnScroll) {
